...
function Menu() {
    ...
    const fetchMenu = async () => {
      try {
        const response = await fetch(
          "https://cafe-backend-p04f.onrender.com/api/menu",
        );
  ...
  const handleSendOrder = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://cafe-backend-p04f.onrender.com/api/orders/create",
        {
          method: "POST",
          headers: {
  ...
  return (
    <div className="menu-container">
      ...
      <header className="top-header">
        ...
        <div className="user-info">
          <span className="user-name">
            Masa {localStorage.getItem("tableNumber") || 1}
          </span>
          <span className="user-pin">
            PIN: <strong>8840</strong>
          </span>
        </div>
      </header>
            ...
            <div className="category-view">
              <div className="menu-intro">
                ...
                <p className="menu-desc">
                  Ürünü açıp içindekileri düzenleyebilir, istemediklerinizi
                  kaldırabilirsiniz.
                </p>
              </div>
                  ...
                  >
                    <div className="cat-details">
                      ...
                      <span className="cat-count">
                        {cat.products ? cat.products.length : 0} ürün
                      </span>
                    </div>
                    ...
                    >
                      ...
                      <div className="product-card-body">
                        ...
                        <div className="product-time">
                          Tahmini hazırlama: 15 dk
                        </div>
                      </div>
                      {expandedProductId === product.id && (
                        <div
                          className="product-expanded-area"
                          onClick={(e) => e.stopPropagation()}
                        >
                          <p className="product-inner-desc">
                            {product.description || "Klasik La Grande lezzeti."}
                          </p>
                          <div className="ingredients-list">
                            <label>
                              <input type="checkbox" defaultChecked /> Dana
                              köftesi
                            </label>
                            <label>
                            ...
                            <label>
                              <input type="checkbox" defaultChecked /> Turşu
                            </label>
                          </div>
                          <button
      ...
      {activeTab === "cart" && (
        <div className="cart-tab-content">
          <div className="menu-intro">
            ...
            <p className="menu-desc">
              Siparişi gönderdiğinizde ürünler fiş olarak burada kalır.
            </p>
          </div>
          ...
          <div className="order-card">
            ...
            <button className="big-add-btn" onClick={handleSendOrder}>
              Siparişi Gönder
            </button>
            <button className="big-danger-btn" onClick={() => setCart([])}>
              Sepeti Temizle
            </button>
          </div>
            ...
            <div className="order-card receipt-card">
              ...
              <div className="receipt-header">
                <span className="receipt-no">
                  ...
                  <span
                    className="badge-new"
                    style={{ backgroundColor: "#b9332c", color: "white" }}
                  >
                    Ödenmedi
                  </span>
                </span>
              ...
              <button className="big-success-btn">
      ...
      <nav className="bottom-nav">
        ...
        <div
          className={`nav-item cart-nav-item ${activeTab === "cart" ? "active" : ""}`}
